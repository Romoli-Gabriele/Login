            ...
            <form method="POST" action="riepilogo.php">
                <li class="list-group-item bg-primary" style="color:white;">
                    ...
                    <fieldset class="row mb-3">
                        ...
                        <div class="col-sm-7">
                            <div class="form-check">
                                <input class="" type="radio" name="genere" id="gridRadios1" value="Maschile" checked>
                    ...
                    <fieldset class="row mb-3">
                        ...
                        <div class="col-sm-7">
                            <select class="form-select" style="width: 12rem; margin: 0"
                                aria-label="Default select example" name="nazionalita">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-7">
                            <input type="email" style="width: 12rem; margin: 0" class="form-control" id="inputMail"
                                name="mail">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-7">
                            <input type="password" style="width: 12rem; margin: 0" class="form-control"
